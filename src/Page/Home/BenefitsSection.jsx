      ...
      <div className="max-w-[1221px] 2xl:w-[100%] xl:w-[100%] lg:w-[90%] md:w-[90%] sm:w-[90%] w-[90%] mx-auto space-y-[2rem] 2xl:py-[4rem] xl:py-[4rem] lg:py-[4rem] md:py-[4rem] sm:py-[2rem] py-[2rem]">
            ...
            {BenefitData.map((item, id) => (
              ...
              >
                ...
                <div className="space-y-[15px] ">
                  ...
                  <p
                    id="howtobuy"
                    className=" font-[400] text-[14px] xs:text-[16px]  text-[#FFF]"
                  >
                    {t(item.subtitlekey)}
                  </p>
                </div>
        ...
        {/* <div className="2xl:hidden xl:hidden lg:hidden md:hidden sm:block block">
          <Swiper
            ...
            keyboard={true}
            spaceBetween={14}
            className="mySwiper !px-[1rem] h-[400px]"
            navigation={true}
          ...
          >
             {BenefitData.map((item, id) => (
              ...
              <div
                key={id}
                className="text-white z-[2] h-[360px] px-8 py-6 space-y-3 cardbenf border border-[#fff]"
              >
                <div className="justify-center items-center 2xl:h-[49px] xl:h-[49px] lg:h-[49px] md:h-[49px] sm:h-[49px] h-[49px]">
                  <img
                    src={item.image}
