        ...
        <div className="betabggr" id="what-is-dreamcars">
            ...
            <div className=" flex justify-center relative items-start  2xl:w-[45%] xl:w-[45%] lg:w-[45%] md:w-[100%] sm:w-[100%] w-[100%] "   >
                ...
                <div className=" 2xl:w-[50%] xl:w-[50%] lg:w-[50%] md:w-[100%] sm:w-[100%] w-[100%] py-[2rem] xs:py-0 xs:text-center sm:text-center  space-y-[25px]">
                   ...
                   <ul className="pl-5 xs:pl-2 space-y-[10px] xs:max-w-[350px] w-[100%] xs:w-[90%] mx-auto ">
                    <li className="list-disc text-[20px] leading-[20px] xs:text-[16px] xs:text-center text-white">{t('BetaSection.para1')}</li>
                    <li className="list-disc text-[20px] leading-[20px] xs:text-[16px] xs:text-center text-white">{t('BetaSection.para2')}</li>
                    ...
                    <div className="pt-[15px]  xs:pt-[10px] flex xs:justify-center">
                        <Button link="#hero" text={`${t('BetaSection.btn')}`} classes="font-[700] bgcolor w-[483px] py-[12px] xs:py-[8px] xs:w-[300px] xs:text-[14px] xs:mx-auto  rounded-[10px]" />
                    </div>
                </div>
