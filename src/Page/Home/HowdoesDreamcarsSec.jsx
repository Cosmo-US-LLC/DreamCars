  ...
  return (
    <div className="Howdoesbggr">
      <div className="2xl:w-[100%] xl:w-[94%] lg:w-[90%] md:w-[90%] sm:w-[90%] w-[90%] max-w-[1232px] mx-auto 2xl:py-[75px] xl:py-[75px] lg:py-[75px] md:py-[75px] sm:py-[30px] py-[30px]">
        <div>
          <h3 className="2xl:text-[46px] xl:text-[46px] lg:text-[46px] md:text-[46px] sm:text-[24px] text-[24px] font-[700] text-center text-[#fff] capitalize xs:max-w-[250px] xs:w-[100%] xs:mx-auto" dangerouslySetInnerHTML={{ __html: `${t('HowdoesDreamcarsSec.title')}` }}>
          </h3>
            ...
            <div className="w-[50%] 2xl:block xl:block lg:block md:block sm:hidden hidden space-y-[15px]">
              {howDoseData.map((item) => (
                <div
                  ...
                  className={`flex items-center h-[116px] backdrop-blur-md gradient-border-mask rounded-[34px] px-[22px] py-[18px]  space-x-[20px] cursor-pointer ${
                    activeId === item.id
                      ? "bg-[#0000008c]" 
                      : "bg-[#d1d5db1f]" 
                  }`}
          ...
          >
              {howDoseData.map((item) => (
                 ...
                 <div
                      key={item.id}
                      onClick={() => setActiveId(item.id)} 
                      className={`flex items-center h-[210px] backdrop-blur-md gradient-border-mask rounded-[34px] px-[22px] py-[18px]  space-x-[20px] cursor-pointer ${
                        activeId === item.id
                          ? "bg-[#0000008c]" 
                          : "bg-[#d1d5db1f]" 
                      }`}
