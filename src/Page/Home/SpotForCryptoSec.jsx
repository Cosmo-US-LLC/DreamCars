...
const SpotForCryptoSec = () => {
  ...
  return (
    <div className="spotbggr py-[3rem] xs:pt-[1rem]">
      <div className="2xl:w-[100%] xl:w-[100%] lg:w-[90%] md:w-[90%] sm:w-[90%] w-[90%] max-w-[1250px] 2xl:space-y-[2rem] xl:space-y-[2rem] lg:space-y-[2rem] md:space-y-[3rem] sm:space-y-[2rem] space-y-[2rem] pt-[4rem] pb-[2rem] xs:py-[1rem] mx-auto bgspot spotbgmob relative z-[8] rounded-[18px] overflow-hidden">
          <div className="spotbgmob hidden xs:block xs:h-[100%] xs:max-h-[330px] xs:absolute xs:z-[3] xs:rounded-t-[18px] w-[100%]"></div>
        <div className="text-center !mt-0 xs:!mt-[30px] space-y-[20px] relative z-[10] xs:px-[15px]">
          <h3 className="text-[40px] xs:text-[24px] font-[700] leading-[130%] capitalize text-[#fff]" dangerouslySetInnerHTML={{ __html: `${t("SpotForCryptoSec.title")}` }}>
          </h3>
          <p className="2xl:text-[20px] xl:text-[20px] lg:text-[20px] md:text-[20px] sm:text-[16px] text-[16px] text-[#fff] max-w-[802px] mx-auto w-[100%]">
          {t("SpotForCryptoSec.para")}
          </p>
        </div>
       
        <div className=" bgspotmob xs:rounded-b-[18px] xs:!pb-[15px]">
            <div className="flex xs:pt-[4rem] justify-center mb-[9rem] xs:mb-[3rem]">
