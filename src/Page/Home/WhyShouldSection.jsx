    ...
    return (
     ...
     <div className=" 2xl:w-[100%] backdrop-blur-md bg-[#d1d5db1f] gradient-border-mask rounded-[34px] xl:w-[100%] lg:w-[90%] md:w-[90%]  sm:w-[90%] max-w-[1221px] w-[90%] mx-auto">
        ...
        WhyShouldData.map((item)=>(
            <div className="w-[100%]  gradient-border-mask rounded-[34px]  2xl:space-y-[25px] xl:space-y-[25px] lg:space-y-[25px] md:space-y-[25px] sm:space-y-[35px] space-y-[35px]  flex flex-col items-center  py-6 2xl:px-6 xl:px-6 lg:px-6 md:px-6 sm:px-4 px-4">
