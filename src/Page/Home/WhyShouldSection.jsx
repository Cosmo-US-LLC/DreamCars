    ...
    return (
     ...
     <div className=" 2xl:w-[100%] backdrop-blur-md bg-[#d1d5db1f] gradient-border-mask rounded-[34px] xl:w-[100%] lg:w-[90%] md:w-[90%]  sm:w-[90%] max-w-[1221px] w-[90%] mx-auto">
        <div className="2xl:px-[40px] xl:px-[40px] lg:px-[40px] md:px-[40px] sm:px-[0rem] px-[1rem] 2xl:py-[65px] xl:py-[65px] lg:py-[65px]  md:py-[65px] sm:py-[2rem] py-[2rem]  2xl:space-y-[3rem] xl:space-y-[3rem] lg:space-y-[3rem] md:space-y-[3rem] sm:space-y-[2rem] space-y-[2rem] ">
            ...
            <h3 className=" 2xl:max-w-[100%] xl:max-w-[100%] lg:max-w-[100%] md:max-w-[100%] sm:max-w-[290px] max-w-[290px] w-[100%] m-auto 2xl:leading-[120%] xl:leading-[120%] lg:leading-[120%] md:leading-[120%] sm:leading-[110%] leading-[110%] text-center 2xl:text-[46px] xl:text-[46px] lg:text-[46px] md:text-[46px] sm:text-[24px] text-[24px] font-[700] text-[#fff]">{t('WhyShouldSec.title')}</h3>
            </div>
        ...
        WhyShouldData.map((item)=>(
            <div className="w-[100%]  gradient-border-mask-no-blur  rounded-[34px]  2xl:space-y-[25px] xl:space-y-[25px] lg:space-y-[25px] md:space-y-[25px] sm:space-y-[35px] space-y-[35px]  flex flex-col items-center  py-6 2xl:px-6 xl:px-6 lg:px-6 md:px-6 sm:px-4 px-4">
