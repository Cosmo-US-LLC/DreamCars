...
const FaqItem = ({ question,answer3, answer,isOpen, toggleItem,answer2,table }) => {
  ...
  return (
    <div className={`border-b-[2px] ${isOpen?"border-[#C3BABA]":"border-[#C3BABA]"}  border-solid`}>
      <div
        className="flex justify-between items-center pt-[16px] xs:pt-[10px] xs:pb-[10] pb-[18px] gap-[25px] cursor-pointer"
        onClick={toggleItem}
      >
        <div
          className={`pt-[24px] xs:pt-[14px] 2xl:text-[24px] xl:text-[24px] lg:text-[24px] md:text-[24px] sm:text-[24px] text-[18px] text-[white] font-[400]`}
        >
           {t(question)}
        </div>
        <h4  className={`text-[18px] xs:text-[10px] border  rounded-full w-[26px] h-[26px] xs:h-[16px] xs:w-[16px]  flex items-center justify-center plusIcon  ${!isOpen ? "text-[#C3BABA] border-[#C3BABA] rotate-0" : "border-[#c3baba] rotate-[-180deg] text-[#c3baba]"}`}>
      ...
      {/* {isOpen && ( */}
        <div className="w-[100%] pr-[10px] pb-[12px]">
          <p
            className="pb-[10px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[18px] text-[#fff] font-[400]"
            dangerouslySetInnerHTML={createMarkup()}
            // ref={contentRef}
          />
          {
            answer2 &&
            <p className="pb-[10px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[18px] text-[#fff] font-[400] pt-[16px]"> {t(answer2)}</p>
          }
          {
            answer3 &&
        ...
        </div>
        {
         ...
         <div className="pb-[2.4rem]">
           <div className="tblbggr pt-[3px] px-[2px] ">
            <div className="flex justify-between faqtabl p-[15px] rounded-t-[12px]">
            ...
            <div className="flex justify-between  border-dashed border-b border-white mx-[3px] py-[10px] px-[25px]">
...
const FaqList = () => {
  ...
  return (
    <>
      <div className="bgfaqsgr">
        <div className="2xl:w-[75%] xl:w-[75%] lg:w-[75%] md:w-[75%] sm:w-[85%] w-[85%] mx-auto pb-[95px] xs:pb-[2rem] xs:pt-[2rem]">
          <div className="text-center ">
          <h2 className="2xl:text-[40px] xl:text-[40px] lg:text-[40px] md:text-[40px] sm:text-[30px] text-[24px]  font-[700] leading-[40px] 2xl:pb-[14px] xl:pb-[14px] text-[#fff] lg:pb-[14px] md:pb-[14px] sm:pb-[12px] pb-[10px]">
          {t('FaqSection.title')}
         </h2>
          </div>
