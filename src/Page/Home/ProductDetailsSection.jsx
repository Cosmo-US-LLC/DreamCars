      ...
      <div className=" space-y-4 py-[4rem] xs:py-[2.2rem] 2xl:w-[100%] xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[100%] w-[90%] max-w-[1276px] mx-auto ">
        ...
        <div className="w-[100%] max-w-[1090px] mx-auto xl:w-[100%] flex flex-col justify-between lg:w-[100%]  xs:w-[100%] sm:w-[100%] md:w-[100%]  ">
            <div className="space-y-[10px]  ">
              <h5 className="2xl:text-[18px] gradient-border-mask-build-mobpara xs:py-[0.8rem] xs:px-[0.5rem] xl:text-[18px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[12px] leading-[130%] font-[400] font-[Lato] text-white text-center ">
                {t("ProductDetails.para1")}
              </h5>
              <h3 className="text-[46px] text-center xs:text-[24px] leading-[1.3] capitalize font-[900] font-[Lato] text-[#fff] ">
                {" "}
            ...
            <div className="xs:pt-[20px] flex justify-between items-center max-w-[1259px] mx-auto w-[100%] xs:pb-[0.8rem] ">
             ...
             <div className="max-w-[270px] h-[142px] w-[100%] flex flex-col items-center justify-center py-[30px] px-[30px] backdrop-blur-md m-0 bg-[#d1d5db1f] space-y-[15px] gradient-border-mask-own-hero rounded-[13.827px]">
                   ...
                   <div className="max-w-[270px] h-[142px] w-[100%] flex flex-col items-center justify-center py-[30px] px-[30px] backdrop-blur-md m-0 bg-[#d1d5db1f] space-y-[15px] gradient-border-mask-own-hero rounded-[13.827px]">
                       <h4 className="text-[#fff] text-[24px] text-center max-w-[220px] w-[100%]  font-[800] leading-[22px] ">Own A Piece Of your Dream Car!</h4>
             ...
             <video
              ...
              <div className="w-[22%] space-y-[20px] 2xl:block xl:block lg:block md:block sm:hidden hidden">
                   <div className="max-w-[270px] h-[142px] w-[100%] flex flex-col items-center justify-center py-[30px] px-[30px] backdrop-blur-md m-0 bg-[#d1d5db1f] space-y-[15px] gradient-border-mask-own-hero rounded-[13.827px]">
                       <h4 className="text-[#fff] text-[24px] text-center max-w-[220px] text-center w-[100%]  font-[800] leading-[22px] ">This Has Never Been Done Before!</h4>
                   ...
                   <div className="max-w-[270px] h-[142px] w-[100%] flex flex-col items-center justify-center py-[30px] px-[0px] backdrop-blur-md m-0 bg-[#d1d5db1f] space-y-[15px] gradient-border-mask-own-hero rounded-[13.827px]">
                       <h4 className="text-[#fff] text-[24px]  w-[100%]  font-[800] leading-[22px] text-center ">Probably the Best New Crypto Project in 2024</h4>
            ...
            <div className="px-[23px] xs:px-[8px] py-[13px] relative z-[9] gradient-border-mask-own-hero-cent backdrop-blur-md bg-[#ffffff08] xs:space-x-2 flex justify-between max-w-[705px] mx-auto items-center">
              <h4 className="2xl:text-[20px] xl:text-[20px] lg:text-[20px] md:text-[20px] sm:text-[20px] text-[12px] font-[800] text-[#fff]">$DCARS Pre-Sale is Live Now</h4>
              ...
              <button className="text-[16px] xs:text-[10px] ftbutton2  font-[700] text-[#000] w-[158px] xs:w-[70px] h-[41px] xs:h-[24px] bgherobtn xs:!rounded-[7px] border-[transparent] border hover:bg-[transparent] hover:text-[#FFD02F] hover:border hover:border-[#FFD02F] "><a href="#dashboard" data-offset="60" onClick={handleLinkClick}>Buy Now </a></button>
          </div>
          ...
          <div className="w-[50%] space-y-[10px] ">
             <div className="max-w-[270px] h-[112px] w-[100%] flex flex-col items-center justify-center py-[20px] px-[15px] backdrop-blur-md m-0 bg-[#d1d5db1f] gradient-border-mask-own-hero rounded-[13.827px]">
                   ...
                   <div className="max-w-[270px] h-[112px] w-[100%] flex flex-col items-center justify-center py-[20px] px-[15px] backdrop-blur-md m-0 bg-[#d1d5db1f] gradient-border-mask-own-hero rounded-[13.827px]">
                       <h4 className="text-[#fff] text-[16.099px] text-center max-w-[220px] w-[100%]  font-[800] leading-[110%]">Own A Piece Of Your Dream Car!</h4>
                   <img className="opacity-[0.6] max-h-[35px]" src={icns4} alt="" />
                   </div>
             </div>
              <div className="w-[50%] space-y-[10px] ">
                   <div className="max-w-[270px] h-[112px] w-[100%] flex flex-col items-center justify-center py-[20px] px-[15px] backdrop-blur-md m-0 bg-[#d1d5db1f] gradient-border-mask-own-hero rounded-[13.827px]">
                       <h4 className="text-[#fff] text-[16.099px] text-center max-w-[220px] text-center w-[100%]  font-[800] leading-[110%] pb-[8px]  ">This Has Never Been Done Before!</h4>
                   <img className="opacity-[0.6] max-h-[35px]" src={icns6} alt="" />
                   </div>
                   <div className="max-w-[270px] h-[112px] w-[100%] flex flex-col items-center justify-center py-[20px] px-[15px] backdrop-blur-md m-0 bg-[#d1d5db1f] gradient-border-mask-own-hero rounded-[13.827px]">
                       <h4 className="text-[#fff] text-[16.099px]  w-[100%]  font-[800] leading-[110%] text-center pb-[10px] ">Probably The Most Underrated Crypto!</h4>
