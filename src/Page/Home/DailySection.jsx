      ...
      <div className="2xl:w-[100%] xl:w-[94%] lg:w-[90%] md:w-[90%] sm:w-[90%] w-[90%] max-w-[1210px] mx-auto pt-[75px] xs:py-[2rem]">
        <div className="flex xs:flex-col-reverse items-center justify-between  xs:flex sm:block md:block xs:backdrop-blur-md xs:bg-[#d1d5db1f] xs:border-r xs:border-t xs:rounded-[23px] xs:p-8">
          ...
          <div className=" 2xl:w-[40%] xl:w-[40%] lg:w-[40%] md:w-[100%] sm:w-[100%] w-[100%] py-[2rem] xs:py-[0rem]  space-y-[20px] xs:space-y-[10px]">
            <h3 className="text-[43px] xs:text-[24px] xs:text-center pr-4 font-[700]  leading-[130%] text-[#fff] " dangerouslySetInnerHTML={{ __html: t('WhitepaperSection.title') }}>
            </h3>
            <h5 className="text-[18px]  font-[400]  xs:text-center leading-[130%] xs:text-[16px] text-white">
