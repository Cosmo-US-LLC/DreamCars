    ...
    return (
        <div className="Examplebggr pb-[75px]">
            ...
            <div className="space-y-[20px] relative z-[1]">
                ...
                <p className="2xl:text-[22px] capitalize xl:text-[22px] lg:text-[22px] md:text-[22px] sm:text-[22px] text-[16px] font-[500] text-center text-[#fff] leading-[150%] xs:leading-[120%]  2xl:w-[80%] xl:w-[80%] lg:w-[80%] md:w-[80%] sm:w-[80%] w-[100%] mx-auto">{t('SimpleExampleSec.para')}</p>
            </div>
            <div className="space-y-[60px] relative z-[1] pt-[48px]">
                <div className="max-w-[424px] w-[100%] mx-auto 2xl:p-[32px] xl:p-[32px] lg:p-[32px] md:p-[32px] sm:p-[32px] p-[20px] backdrop-blur-md m-0 bg-[#d1d5db1f] gradient-border-mask rounded-[34px]">
