  ...
  return (
   <div className="pressbggr">
     <div className="w-[70%] max-w-[1440px]  py-[3rem] xs:py-[2rem] mx-auto space-y-[50px] xs:space-y-[15px]">
      <div>
        <h2 className="2xl:text-[40px] xl:text-[40px] lg:text-[40px] md:text-[40px] sm:text-[30px] text-[24px] text-center text-[#FFF] font-[700] leading-[40px] 2xl:pb-[39px] xl:pb-[39px] lg:pb-[39px] md:pb-[39px] sm:pb-[30px] pb-[10px]">
        {t('Media.title')}
        </h2>
      </div>
      <Swiper
