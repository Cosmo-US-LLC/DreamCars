        ...
        <div className="dcmodelbggr">
           ...
           <div className="space-y-[36px] pt-[25px] w-[100%] ">
               ...
               <div className="2xl:flex xl:flex lg:flex md:flex sm:block block justify-between w-[100%] relative xs:space-y-[20px]">
                   <div className="max-w-[368px] 2xl:h-[367px] xl:h-[367px] lg:h-[367px] md:h-[367px] sm:h-[auto] h-[auto] w-[100%] py-[38px] px-[30px] 2xl:backdrop-blur-md xl:backdrop-blur-md lg:backdrop-blur-md md:backdrop-blur-md sm:backdrop-blur-none backdrop-blur-none m-0 2xl:!bg-[#8b8b8b1f] xl:!bg-[#8b8b8b1f] lg:!bg-[#8b8b8b1f] md:!bg-[#8b8b8b1f] sm:!bg-[transparent] !bg-[transparent] gradient-border-mask-no-blur rounded-[34px] space-y-[6px] ">
                   ...
                   <div className="max-w-[368px] 2xl:h-[367px] xl:h-[367px] lg:h-[367px] md:h-[367px] sm:h-[auto] h-[auto] w-[100%] py-[38px] px-[30px] 2xl:backdrop-blur-md xl:backdrop-blur-md lg:backdrop-blur-md md:backdrop-blur-md sm:backdrop-blur-none backdrop-blur-none m-0 2xl:!bg-[#8b8b8b1f] xl:!bg-[#8b8b8b1f] lg:!bg-[#8b8b8b1f] md:!bg-[#8b8b8b1f] sm:!bg-[transparent] !bg-[transparent] space-y-[6px] gradient-border-mask-no-blur rounded-[34px]">
