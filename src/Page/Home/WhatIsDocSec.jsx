      ...
      <div className="py-[60px] xs:py-[35px]">
        <div className="backdrop-blur-md 2xl:flex xl:flex lg:flex md:flex sm:block block justify-between py-[60px] xs:py-[30px] px-[54px] xs:px-[30px] bg-[#d1d5db1f] gradient-border-mask rounded-[34px] 2xl:w-[100%] xl:w-[100%] lg:w-[90%] md:w-[90%] sm:w-[90%] w-[90%] max-w-[1240px] mx-auto ">
          ...
          <div className="2xl:w-[100%] relative z-[1] xl:w-[100%] lg:w-[100%] max-w-[638px] md:w-[100%] sm:w-[100%] w-[100%]  xs:py-0  space-y-[25px]">
            <h3 className="text-[46px] xs:text-center xs:text-[24px] font-[700] leading-[130%] text-[#fff]" dangerouslySetInnerHTML={{ __html: `${t('WhatMakesSec.title')}` }} />
            <p className="2xl:text-[20px] xl:text-[20px] lg:text-[20px] md:text-[20px] sm:text-[16px] text-[16px] font-[400] text-[#fff] max-w-[570px] w-[100%]" dangerouslySetInnerHTML={{ __html: `${t('WhatMakesSec.para')}` }} />
              <ul className="pl-5 !mt-[15px]  text-[#fff] 2xl:text-[20px] xl:text-[20px] lg:text-[20px] md:text-[20px] sm:text-[16px] text-[16px] font-[400] leading-[130%] xs:space-y-[6px] list-disc">
                <li>{t("WhatMakesSec.lisec1")}</li>
                <li>{t("WhatMakesSec.lisec2")}</li>
                <li>{t("WhatMakesSec.lisec3")}</li>
                <li>{t("WhatMakesSec.lisec4")}</li>
                <li>{t("WhatMakesSec.lisec5")}</li>
              </ul>
