...
import Aauaimgmob from "../../assects/images/aquaimgmob.png";
      ...
      <div className="2xl:w-[100%] xl:w-[100%] lg:w-[90%] md:w-[90%] sm:w-[90%] w-[90%] max-w-[1180px]  pt-[1rem] pb-[2rem] xs:py-[2rem] mx-auto ">
       ...
       <div className="flex justify-between xs:block ">
          <div className="space-y-[12px] w-[52%] xs:w-[100%] relative">
            <h3 className="text-[46px] leading-[130%] xs:text-[24px] xs:text-center font-[700] text-[white] ">
            {t('Acquired.title')} 
              <span className="text-[#FED23D]">{t('Acquired.title2')}</span>{" "}
            </h3>
            <div className="space-y-[15px]">
              <p className="text-[18px] xs:text-[16px] xs:text-center font-[400] text-[#fff]">
              {t('Acquired.para1')}
              </p>
              <p className="text-[18px] xs:text-[16px] xs:text-center font-[400] text-[#fff]">
              {t('Acquired.para2')}
